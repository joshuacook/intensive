...
del categorical_encoded_features_insignificant_variance
del categorical_encoded_features_insignificant_variance_out_rem
del categorical_encoded_features_significant_variance
del categorical_encoded_features_significant_variance_centered
del categorical_encoded_features_significant_variance_centered_out_rem
del categorical_encoded_out_rem_df
del numeric_df
del numeric_gelman_categorical_significant
del numeric_gelman_categorical_significant_pca
del numeric_log_df
del numeric_log_gel_sc_df
del numeric_log_gel_sc_out_rem_df
del numeric_log_std_sc_df
del numeric_log_std_sc_out_rem_df
del numeric_log_std_sc_out_rem_pca_df                                    
